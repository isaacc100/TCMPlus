...
public partial class RecentSessionsWindow : Window
{
    ...
    private async Task ReloadAsync() { SessionsList.ItemsSource = await _store.GetRecentAsync(); SessionDetails.Text = "Select a shift to load, rename, export, or delete it."; }
